...
const Auth = () => {
  ...
  const handleOAuth = async (provider: 'google' | 'apple') => {
    ...
    try {
      ...
      toast({
        title: `${provider === 'google' ? 'Google' : 'Apple'} Sign-In Error`,
        description: error.message,
        variant: "destructive",
      });
      setLoading(false);
  ...
  return (
    <main className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      >
        ...
        <span className="text-sm font-mono" style={{ color: 'hsl(40 50% 70%)' }}>Return</span>
      </motion.button>
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm font-mono" style={{ color: 'hsl(40 50% 60%)' }}>
              {mode === 'login' && 'Enter your credentials to continue'}
              {mode === 'signup' && 'Begin your journey as a Pharmer'}
              {mode === 'reset' && 'Recover access to your path'}
            </p>
          </div>
            ...
            {mode === 'reset' ? (
              ...
              >
                {resetSent ? (
                  <div className="text-center py-6 space-y-4">
                    <div className="w-16 h-16 mx-auto rounded-full flex items-center justify-center" style={{ background: 'hsl(51 80% 40% / 0.2)', border: '1px solid hsl(51 80% 50%)' }}>
                      <Mail className="w-8 h-8" style={{ color: 'hsl(51 100% 60%)' }} />
                    </div>
                    <p className="font-mono text-sm" style={{ color: 'hsl(40 50% 70%)' }}>
                      Check <span style={{ color: 'hsl(51 100% 60%)' }}>{email}</span> for a reset link.
                    </p>
                    <button
                  ...
                  <form onSubmit={handleEmailAuth} className="space-y-4">
                    <div>
                      <Label htmlFor="reset-email" className="font-mono text-xs" style={{ color: 'hsl(40 50% 60%)' }}>EMAIL</Label>
              ...
              >
                ...
                <div className="space-y-3 mb-4">
                  <Button
                    type="button"
                    className="w-full py-6 font-mono"
                    variant="outline"
                    style={{
                ...
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-xs font-mono" style={{ color: 'hsl(0 0% 45%)' }}>or</span>
                  <div className="flex-1 h-px" style={{ background: 'hsl(0 0% 25%)' }} />
                </div>
                ...
                <form onSubmit={handleEmailAuth} className="space-y-4">
                  <AnimatePresence mode="wait">
                    {mode === 'signup' && (
                      <motion.div
                        ...
                        transition={{ duration: 0.2 }}
                      >
                        <Label htmlFor="displayName" className="font-mono text-xs" style={{ color: 'hsl(40 50% 60%)' }}>PHARMER NAME</Label>
                        <div className="relative mt-1">
                  ...
                  <div>
                    <Label htmlFor="email" className="font-mono text-xs" style={{ color: 'hsl(40 50% 60%)' }}>EMAIL</Label>
                    <div className="relative mt-1">
                      <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: 'hsl(40 40% 50%)' }} />
                      <Input
                        id="email"
                  ...
                  <div>
                    <div className="flex items-center justify-between">
                      <Label htmlFor="password" className="font-mono text-xs" style={{ color: 'hsl(40 50% 60%)' }}>PASSWORD</Label>
                      {mode === 'login' && (
                        <button
                          type="button"
                          className="font-mono text-xs"
                          style={{ color: 'hsl(51 80% 50%)' }}
                ...
                <p className="text-center text-xs font-mono mt-6" style={{ color: 'hsl(0 0% 45%)' }}>
                  {mode === 'login'

...
const levelContent: Record<number, {
  ...
  2: {
    ...
    transmission: 'We honor the Olmec (Magnetism), the Toltec (Dream), and the Inca (Hydrology). The stone is alive. We use Basalt to structure the soil\'s memory.',
  ...
  3: {
    ...
    transmission: 'We map the farm by Dogon Starlight, Maya Time, and Vedic Fire. We are the antenna between the Sky and the Clay.',
  ...
  4: {
    ...
    transmission: 'We refine the harvest using Kemetic Gold Standards and the Joseon (Morning Calm) fermentation. We turn the bitter weed into the sweet wine.',

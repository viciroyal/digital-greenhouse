...
import { Scan, Beaker, TrendingUp, X } from 'lucide-react';
 ...
 * 
 * Note: This uses a drawer pattern (slides from right) rather than 
 * a centered modal, so it doesn't use GlassModal directly but follows
 * the same glassmorphism design system.
 */
const SpectralVault = ({ track, isOpen, onClose }: SpectralVaultProps) => {
  ...
  return (
    <>
      {/* Backdrop - Glassmorphism standard */}
      <motion.div

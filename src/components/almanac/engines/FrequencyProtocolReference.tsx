...
const FREQUENCY_PROTOCOLS: FrequencyProtocol[] = [
  ...
  },
  {
    hz: 741,
    color: 'hsl(210 60% 50%)',
    culturalRole: 'The Voice & Expression',
    dominantMineral: 'Potassium',
    mineralSymbol: 'K',
    cropGuild: ['Blueberries', 'Grapes', 'Cucumbers'],
    soilProtocolFocus: 'The Signal',
    soilProtocolDetail: 'Potassium for fruit sugar transport and flavor.',
  },
  {
    hz: 852,
    color: 'hsl(270 50% 50%)',
    culturalRole: 'The Vision & Intuition',
    dominantMineral: 'Magnesium',
    mineralSymbol: 'Mg',
    cropGuild: ['Eggplant', 'Figs', 'Lavender'],
    soilProtocolFocus: 'The Chlorophyll',
    soilProtocolDetail: 'Magnesium as the heart of chlorophyll molecule.',
  },
  {
    hz: 963,
    color: 'hsl(300 50% 50%)',
    culturalRole: 'The Source & Seed',
    dominantMineral: 'Sulfur',
    mineralSymbol: 'S',
    cropGuild: ['Garlic', 'Onions', 'Alliums'],
    soilProtocolFocus: 'The Sanctuary',
    soilProtocolDetail: 'Sulfur compounds for pest resistance and storage.',
  },
];
